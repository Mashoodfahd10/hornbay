...
<div class="btn-group" style={{marginLeft:"1000px",marginTop:"50px"}}>
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="/"/>Sort By Popularity</li>
    <li><a class="dropdown-item" href="/"/>Sort by Average Rating</li>
    <li><a class="dropdown-item" href="/"/>Sort by Latest</li>
  </ul>
      ...
      <div className="row"  style={{marginTop:"100px"}}>
        <div className="col-3">
          <img
            ...
            alt="horns" style={{ height: "278px", width: "351px",border:" 2px solid #f2f2f2" }}/>
            <div className="container text-center " style={{border:" 2px solid #f2f2f2"}}>
            <h2> Buy this Now</h2>
            ...
            <div className="col-3">
              ...
              alt="trucksss"  style={{ height: "278px", width: "351px",border:" 2px solid #f2f2f2" }}/>
